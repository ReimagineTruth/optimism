...
func (s *ManagedMode) Start(ctx context.Context) error {
	...
	interopBackend := &InteropBackend{}
	s.srv.AddAPI(gethrpc.API{
		Namespace:     "interop",
		Service:       interopBackend,
		Authenticated: true,
	})
...
// TODO fix subscription signature
func (ib *InteropBackend) SubscribeUnsafeBlocks(ctx context.Context) (ethereum.Subscription, error) {
	// TODO create subscription, and get new unsafe-block events to feed into it
	return nil, nil
}

func (ib *InteropBackend) UpdateCrossUnsafe(ctx context.Context, ref eth.BlockRef) error {
	// TODO cross-unsafe update -> fire event
	// TODO await engine update or ctx timeout -> error maybe
	return nil
}

func (ib *InteropBackend) UpdateCrossSafe(ctx context.Context, ref eth.BlockRef) error {
	// TODO cross-safe update -> fire event
	// TODO await forkchoice update or ctx timeout -> error maybe
	return nil
}

func (ib *InteropBackend) UpdateFinalized(ctx context.Context, ref eth.BlockRef) error {
	// TODO finalized update -> fire event
	// TODO await forkchoice update or ctx timeout -> error maybe
	return nil
}

func (ib *InteropBackend) AnchorPoint(ctx context.Context) (l1, l2 eth.BlockRef, err error) {
	// TODO return genesis anchor point from rollup config
	return
}

func (ib *InteropBackend) Reset(ctx context.Context) error {
	// TODO fire reset event
	// TODO await reset-confirmed event or ctx timeout
	return nil
}

func (ib *InteropBackend) TryDeriveNext(ctx context.Context, nextL1 eth.BlockRef) error {
...
func (ib *InteropBackend) FetchReceipts(ctx context.Context, id eth.BlockID) (types.Receipts, error) {
	// TODO use execution engine to fetch the receipts
	return nil, nil
}

func (ib *InteropBackend) BlockRefByNumber(ctx context.Context, num hexutil.Uint64) (eth.BlockRef, error) {
	return eth.BlockRef{}, nil
}

func (ib *InteropBackend) ChainID(ctx context.Context) (supervisortypes.ChainID, error) {
