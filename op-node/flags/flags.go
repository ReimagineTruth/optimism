...
var (
	...
	InteropFollow = &cli.StringFlag{
		Name: "interop.follow",
		Usage: "Interop follow-mode: RPC address of interop supervisor to follow for cross-chain safety verification." +
			"Applies only to Interop-enabled networks.",
		EnvVars:  prefixEnvVars("INTEROP_FOLLOW"),
